...
%%% legend %%%
\pic[scale=1] (carrier) at (4,8.5) {pypsa carrier={white}};
\node at (carrier-anchor) {Carrier};
\pic[scale=1] (storage) at (7,8.5) {pypsa storage={white}};
\node at (storage-anchor) {Storage};
\pic[scale=1] (generator) at (10,8.5) {pypsa generator={white}};
\node at (generator-anchor) {Generator};
\pic[scale=1] (bus) at (13,8.5) {pypsa bus={white}};
\node at (bus-anchor) {Bus};
\pic[scale=1] (sink) at (16,8.5) {pypsa sink={white}};
\node at (sink-anchor) {Sink};
\draw [main stream] (19,8.5) -- (21,8.5);
\node [above] at (20,8.5) {Flow};
