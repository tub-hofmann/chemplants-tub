...
\node [below, anchor=north east] at (ihx1-pipes right) {\footnotesize WRG1};
%ihx2
\pic[rotate=90,xscale=-1] (ihx2) at (4,5) {heat-exchanger-iso-1};
\node [below, anchor=north west] at (ihx2-pipes right) {\footnotesize WRG2};
%compressor1
\pic[scale=0.5] (cp1) at (5.5,6.5) {compressor-iso};
\node [left, anchor=south east] at (cp1-outlet) {\footnotesize VE1};
%compressor2
...
\node [left, signalbraun] at (5.5,8) {\footnotesize 33};
\node [above, signalbraun] at (3.5,8.5) {\footnotesize 34};
\node [above, signalbraun] at (3,5.25) {\footnotesize 35};
\node [below, signalbraun] at (3,4.75) {\footnotesize 36};
\node [right, signalbraun] at (1,5) {\footnotesize 37};
\node [left, signalbraun] at (4,2.75) {\footnotesize 38};
\node [above, signalbraun] at (2.5,2.25) {\footnotesize 39};
