...
\node [align=center] at (7.5,2.5) {\footnotesize für alle Fälle gilt $T_{12} \leq T_{11}$};
...
\node [align=center] at (wp-anchor) {\footnotesize WP};
...
\node [below] at (0,-3.4) {\footnotesize $LZ_\text{WP} = \dfrac{\dot H_{22}-\dot H_{21}}{\dot W_\text{el}}$};
...
\node [align=center] at (wp1-anchor) {\footnotesize WP\\ \tiny Raumwärme};
...
%%% mathematics %%%
\node [align=center, below] at (5,-2.2) {\footnotesize Verdampfer als \\ \footnotesize dissipative Komponente};
%\node [below] at (5.625,-2.7) {\footnotesize $\dot E_{11}-\dot E_{12}<0$};
\node [below] at (5,-3.4) {\footnotesize $\varepsilon_\text{WP} = \dfrac{\dot E_{22}-\dot E_{21}}{\dot W_\text{el}}$};
...
\node [align=center] at (wp2-anchor) {\tiny Kombinierte \\ \tiny Kältemaschine/\\ \tiny Wärmepumpe};
...
\node [below] at (10,-3.4) {\footnotesize $\varepsilon_\text{WP} = \dfrac{\left(\dot E_{22}-\dot E_{21}\right) + \left(\dot E_{12} - \dot E_{11}\right)}{\dot W_\text{el}}$};
...
\node [align=center] at (wp3-anchor) {\footnotesize HT-WP};
...
\node [below] at (15,-2.1) {\footnotesize $T_{12} \geq T_0 \quad\text{und}\quad T_{11} > T_0$};
\node [below] at (15.625,-2.7) {\footnotesize $\dot E_{11}-\dot E_{12}>0$};
\node [below] at (15,-3.4) {\footnotesize $\varepsilon_\text{WP} = \dfrac{\dot E_{22}-\dot E_{21}}{\dot W_\text{el} + \left(\dot E_{11} - \dot E_{12}\right)}$};
