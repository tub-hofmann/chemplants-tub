...
\node [above right] at (2.75,-0.5) {\footnotesize 11};
\draw [main stream, signalgrau] (ev-shell bottom left) -- (2.25,-0.5);
\node [above left] at (2.25,-0.5) {\footnotesize 12};
\draw [main stream, signalgruen] (2.75,10) -- (co-pipes bottom);
\node [below right] at (2.75,10) {\footnotesize 21};
\draw [main stream, signalgruen] (co-pipes top) -- (2.25,10);
\node [below left] at (2.25,10) {\footnotesize 22};
